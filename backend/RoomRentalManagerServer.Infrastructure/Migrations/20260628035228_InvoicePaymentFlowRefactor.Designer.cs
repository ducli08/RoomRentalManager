...
namespace RoomRentalManagerServer.Infrastructure.Migrations
{
    ...
    [Migration("20260628035228_InvoicePaymentFlowRefactor")]
    partial class InvoicePaymentFlowRefactor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoomRentalManagerServer.Domain.ModelEntities.Contracts.Contract", b =>
                {
                    ...
                    b.Property<decimal>("GarbageFeePerMonthPerPerson")
                        .HasColumnType("numeric")
                        .HasColumnName("garbageFeePerMonthPerPerson");
                    ...
                    b.PrimitiveCollection<long[]>("TenantIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint[]")
            ...
            modelBuilder.Entity("RoomRentalManagerServer.Domain.ModelEntities.Invoices.Invoice", b =>
                {
                    ...
                    b.Property<int>("OccupancyDaysSnapshot")
                        .HasColumnType("integer")
                        .HasColumnName("occupancyDaysSnapshot");

                    b.Property<decimal>("PaidAmount")
                        .HasColumnType("numeric")
                        .HasColumnName("paidAmount");

                    b.Property<DateTime>("PeriodEndSnapshot")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("periodEndSnapshot");

                    b.Property<DateTime>("PeriodStartSnapshot")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("periodStartSnapshot");

                    b.Property<string>("RoomNameSnapshot")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("roomNameSnapshot");
                    ...
                    b.Property<string>("TenantNameSnapshot")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("tenantNameSnapshot");
            ...
            modelBuilder.Entity("RoomRentalManagerServer.Domain.ModelEntities.Invoices.InvoiceItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
